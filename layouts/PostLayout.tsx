...
export default function PostLayout({ content, authorDetails, next, prev, children }: LayoutProps) {
  ...
  return (
    <SectionContainer>
      <ScrollTopAndComment />
      <article>
        <div className="xl:divide-y xl:divide-violet-100 xl:dark:divide-gray-700">
          ...
          <div className="grid-rows-[auto_1fr] divide-y divide-violet-100 pb-8 dark:divide-gray-700">
            <dl className="py-3">
            ...
            <footer>
              <div className="divide-y divide-violet-100 text-sm leading-5 font-medium dark:divide-gray-700">
                {tags && (
                  <div className="py-4">
